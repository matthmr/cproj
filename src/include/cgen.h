...
// buffered bytes for the output buffer
#  ifndef CGEN_OUTBUF
#    define CGEN_OUTBUF (4096)
#  endif

// notice message; keep the two trailing newlines
#  ifndef CGEN_AUTOGEN_NOTICE
#    define CGEN_AUTOGEN_NOTICE "// THIS FILE IS AUTO-GENERATED. DO NOT EDIT"
#  endif
